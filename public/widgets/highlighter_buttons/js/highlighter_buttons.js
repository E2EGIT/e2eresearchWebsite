$(window).load(function(){
    ...
    for(var i=0; i<phraseLen_; i++){
        ...
        if(phrase_[i].indexOf(",") != -1){
            ...
            for(var j= 0; j< getArrayLen; j++){
                ...
                $(".image_block").append("<div class='initial notDefined phrase_"+i+" phraseGrp_"+j+"' group='yes' groupId = "+i+"></div>");
                $(".phrase_"+i+""+".phraseGrp_"+j).css({"left":phrase_x1+"px","top":phrase_y1+"px","width":phrase_x2+"px","height":phrase_y2+"px"});
            ...
            $(".image_block").append("<div class='initial notDefined phrase_"+i+"'></div>");
    
           
            $(".phrase_"+i).css({"left":phrase_x1+"px","top":phrase_y1+"px","width":phrase_x2+"px","height":phrase_y2+"px"});
	...
	$(".initial").hover(function(){
		...
		$(".initial[groupid='"+gid+"']").not(".green").not(".red").addClass("hover");
