...
$(document).ready(function () {
  $(".IremapContainer").append(
    '<span class="tipForIre" id="tipForIre"></span><div class="noneoftheseForIre" id="nonofIre" onClick="noneBtnForIre();" data-info="' +
      noneoftheseForIre +
      '">' +
      noneofTextForIre +
      "</div>"
  ...
  if (is_ie8 || is_ie7 || is_ie6) {
    $(".IremapContainer").html(
      "<div class='msgblock'><h2 class='msg'>Your Browser does not support. Please upgrade your browser..</h2></div>"
    );
  ...
  $(".tipForIre").css({
    ...
    "-moz-box-shadow":
      "2px 3px 6px " + map_config["default"]["namesShadowColor"],
    "-webkit-box-shadow":
      "2px 3px 6px " + map_config["default"]["namesShadowColor"],
  });
  ...
  if ($("#shadow").find("path").eq(0).attr("fill") != "undefined") {
    ...
    $("#shadow")
      .find("path")
      .attr({ fill: map_config["default"]["shadowcolor"] })
      .css({ "fill-opacity": a });
  }
});
...
function addEvent(e, a) {
  ...
  if (map_config[e]["enable"] == true) {
    ...
    d.hover(
      function () {
        $("#tipForIre").show().html(map_config[e]["name"]);
        c.css({ fill: map_config[e]["overcolor"] });
      },
      function () {
        $("#tipForIre").hide();
    ...
    d.mousemove(function (i) {
      var g = i.pageX - 40,
        j = i.pageY + -40;
      var h = $("#tipForIre").outerWidth(),
        f = $("#tipForIre").outerHeight(),
        g =
          g + h > $(document).scrollLeft() + $(window).width()
            ? g - h - 20 * 2
            : g;
      j =
        j + f > $(document).scrollTop() + $(window).height()
          ? $(document).scrollTop() + $(window).height() - f - 10
          : j;
      $("#tipForIre").css({ left: g, top: j });
    });
  }
}
...
$("#regionIre path").on("click", function () {
  ...
  function eliminateDuplicates(valueStr) {
    (len = valueArr.length), (out = []), (obj = {});
  ...
  OutputValuesForIre(eliminateDuplicates(valueStr));
});
