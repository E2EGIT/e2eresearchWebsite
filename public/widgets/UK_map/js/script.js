$(document).ready(function () {
  $("#htmlComp").append(
    '<span class="tipForUK" id="tipForUK">SCOTLAND</span><div id="nonofUK" onClick="noneBtnForUk();" class="noneoftheseForUK" data-info="' +
      noneoftheseForUk +
      '">' +
      noneofTextForUk +
      "</div>"
  ...
  if (is_ie8 || is_ie7) {
    $("#htmlComp").html(
      "<h2 class='msg'>Your Browser does not support. Please upgrade your browser..</h2>"
    );
  ...
  function addEvent(e) {
    ...
    if (map_config[e]["enable"] == true) {
      ...
      d.mousemove(function (i) {
        var g = i.pageX - 20,
          j = i.pageY + -38;
        var h = $("#tipForUK").outerWidth(),
          f = $("#tipForUK").outerHeight(),
          g =
  ...
  var map_config = {
    ...
    sc4: {
      namesId: "Yorkshire and The Humberside",
      name: "Yorkshire and The Humberside",
      url: "#",
      downcolor: "#3d36a0",
      enable: true,
    },
    sc5: {
      namesId: "East Midlands",
      name: "EAST MIDLANDS",
      url: "#",
      downcolor: "#22a69e",
      enable: true,
